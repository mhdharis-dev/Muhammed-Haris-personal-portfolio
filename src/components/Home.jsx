        ...
        <div className="flex-1 text-center md:text-left">
          ...
          >
            ...
            <a
              ...
              rel="noreferrer"
              aria-label="WhatsApp"
              className="w-11 h-11 rounded-full bg-white border border-[rgba(41,82,227,0.12)] text-[#475569] hover:bg-[#25D366] hover:text-white transition-all shadow-sm flex items-center justify-center"
            >
